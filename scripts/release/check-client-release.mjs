...
const checks = [
  ...
  ["node", ["--check", "scripts/release/check-production-readiness.mjs"], "production readiness syntax"],
  ...
  ["node", ["--test", "tests/production-readiness.test.mjs"], "production readiness tests"],
