...
const zhCN: AppMessages = {
  ...
  nativeCapabilities: {
    ...
    externalTitle: "页面打开",
    externalDescription: "确认同源页面内嵌打开和系统浏览器打开能力。",
    mapTitle: "地图导航",
    mapShortLabel: "导",
    ...
    barcodeTitle: "扫码",
    barcodeShortLabel: "扫",
    barcodeDescription: "识别二维码和常见一维码，结果会留在当前页。",
    barcodeScan: "扫码",
    ...
    barcodeCameraDescription: "使用当前页面的相机取景框识别二维码和条形码，识别成功后自动停止。",
    ...
    mapPickerDescription: "仅已安装且已确认可用的地图应用可以打开导航。",
    ...
    webviewDescription: "在客户端内打开同源页面，用于确认内嵌页面跳转能力。",
    ...
    diagnosticsEntryDescription: "查看运行环境、权限、媒体、通知和内嵌页面能力。",
    opening: "处理中...",
...
const enUS: AppMessages = {
  ...
  nativeCapabilities: {
    ...
    externalDescription: "Confirm same-origin in-app opening and system browser opening.",
    ...
    barcodeTitle: "Scan",
    barcodeShortLabel: "S",
    barcodeDescription: "Read QR codes and common 1D barcodes. Results stay on this page.",
    barcodeScan: "Scan",
    ...
    barcodeCameraDescription: "Use the in-page camera viewfinder to read QR codes and barcodes. Scanning stops after a match.",
    ...
    diagnosticsDescription: "Inspect the current client runtime, permissions, and system call status.",
    ...
    mapPickerDescription: "Only installed and confirmed map apps can open navigation.",
    ...
    webviewDescription: "Open a same-origin page inside the client to verify embedded page navigation.",
    ...
    diagnosticsEntryDescription: "Inspect runtime, permissions, media, notifications, and embedded page capability.",
    opening: "Processing...",
