...
const zhCN: AppMessages = {
  ...
  nativeCapabilities: {
    ...
    barcodeTitle: "扫码",
    barcodeDescription: "按用户动作请求相机权限，支持常见二维码和一维码；当前壳子不支持原生扫码时会给出明确原因。",
    barcodeScan: "扫码",
    ...
    mapPickerDescription: "已安装的地图可直接打开；未安装或无法确认的地图会禁用，可重新检测。",
    mapVisibilityLimited: "Android 11+ 需要壳声明应用可见性；若已安装仍显示未安装，请重新检测或安装新包后重试。",
    mapCheckUnavailable: "当前环境暂时无法读取已安装应用，请重新检测或安装最新版壳后重试。",
    mapRefresh: "重新检测",
    mapTryOpen: "尝试打开",
    mapOpenWith: "打开",
    requestPermission: "请求权限",
    permissionActionDriven: "该权限会在对应操作时由系统按需询问，不单独弹窗。",
    permissionActionDrivenShort: "去验证",
    ...
    openDownloads: "客户端下载",
    opening: "打开中...",
    opened: "操作已触发，请查看系统响应；返回后页面会自动复位。",
    cancelled: "已取消，未选择文件。",
...
const enUS: AppMessages = {
  ...
  nativeCapabilities: {
    ...
    barcodeTitle: "Scan",
    barcodeDescription: "Camera permission is requested only after user action. Common QR codes and 1D barcodes are supported; unsupported native scan paths return a clear reason.",
    barcodeScan: "Scan",
    ...
    mapPickerDescription: "Installed map apps can be opened directly. Missing or uncertain apps are disabled; refresh detection if needed.",
    mapVisibilityLimited: "Android 11+ requires package visibility declarations. If an installed app is not detected, refresh detection or install the latest shell.",
    mapCheckUnavailable: "This runtime cannot read installed apps right now. Refresh detection or install the latest shell.",
    mapRefresh: "Refresh",
    mapTryOpen: "Try",
    mapOpenWith: "Open",
    ...
    permissionActionDrivenShort: "Verify",
    ...
    opening: "Opening...",
    opened: "Action started. Check the system response; the page resets after you return.",
